---
title: "Exploratory_&_Econometric_Analysis"
...
We previously found a negative relationship between rice prices and poverty (using toilet access as a proxy). But how does that economic shift impact family structure, especially child dependency (number of children per working-age adult)?
...
While the previous plot emphasized clarity and numeric labeling, the visualization below adds a new dimension: poverty (measured by % of households without toilet access) shown through color intensity. By faceting the data by area type and mapping poverty levels to a gradient, this plot reveals how both urban and rural areas experience different combinations of rice price, child dependency, and deprivation. This layered view helps surface inequality patterns that are not immediately visible in simpler plots.

```{r fig.align='center', echo=FALSE, out.width='85%'}
knitr::include_graphics("~/Desktop/ECNS_560_REDO/Plots/child_dependency_vs_riceprice_facet_colored.png")
```

What this chart tells us: Child Dependency (y-axis) shows how many children there are relative to working-age adults.

Rice Price (x-axis) is a proxy for broader economic conditions — higher prices often come with inflation or better incomes.

Color of the bubbles shows the percentage of households without toilets — a simple but powerful proxy for poverty. Red = worse poverty, green = better sanitation.



*In Rural Areas:*
Lower rice prices are associated with higher poverty (redder bubbles) and higher child dependency.

As rice prices rise (moving right), we see:

Greener bubbles → better toilet access → lower poverty.

Slight drop in child dependency.

This suggests that when rural households are doing a little better economically (can afford more expensive rice), they also have fewer children to support and improved sanitation.
...
*In Urban Areas:*
Urban areas also show a decline in child dependency as rice prices go up.

However, they start at a higher dependency level than rural areas.

Poverty levels improve (bubbles become greener), but not as dramatically as in rural areas.

This could reflect urban migration, where lower-income families with more children move into cities, possibly skewing urban child dependency higher even as economic indicators improve.





# Why are lower rice prices linked to higher poverty in rural areas?
- Answer: In places like Rajshahi, many rural households don’t just consume rice — they grow it. 

That means:

When rice prices fall, the money farmers earn from selling their crops goes down.

Lower selling prices = lower income for rural producers.

And when incomes drop, basic needs like sanitation, healthcare, and education suffer — hence, higher poverty (as shown by more red bubbles).



Farmers aren’t just buyers — they’re sellers:
So while low food prices might seem like a good thing for consumers in the short term, for rural areas dependent on agriculture, it can be harmful.

High rice prices, on the other hand, often signal:
...
This can lead to more investment in toilets, smaller family sizes, and a better overall quality of life — which is what your data is showing.


Moreover, When rice is cheap, rural farmers earn less — and that drives poverty. When rice prices rise, those same farming communities benefit economically, which helps reduce poverty


# Taking the multidimensional view even further, the following plot introduces bubble size to represent average family size, while still using color to indicate poverty (% without toilet access). By faceting urban and rural areas, this visualization combines all three key indicators — rice price, child dependency, and poverty — into one cohesive view. This allows for a deeper interpretation of how family structure and living conditions co-vary across spatial and economic contexts.


```{r fig.align='center', echo=FALSE, out.width='85%'}
knitr::include_graphics("~/Desktop/ECNS_560_REDO/Plots/child_dependency_riceprice_bubble_facet.png")
```
This visualization highlights that poverty, family size, and economic factors are deeply intertwined with child dependency, and these relationships vary meaningfully across urban and rural settings.

*Rural areas:*

Larger red bubbles on the left = lower rice prices, higher poverty (red color), bigger families, and higher child dependency.

When rice prices are higher, especially in rural areas, it usually means farmers are earning more. Since many rural families depend on farming, this extra income makes a big difference.

With more money coming in:

Families might choose to have fewer children, because they’re no longer relying on large households to support the farm.

They can afford better living conditions, like access to toilets and healthcare.

Overall, families become less burdened — smaller, healthier, and more stable.



# On the other hand, when rice prices are low, it often hurts the same families who grow it. That can lead to:

Bigger families (as a form of security),

Higher child dependency (more kids per adult),

And worse sanitation access (poverty-related issues).


*Urban areas:*

In urban settings, most people don’t grow rice — they buy it. So when rice prices go up, it actually makes life harder for many urban families, especially the poor. Food becomes more expensive, and that can strain household budgets.

But interestingly, the data shows that even in urban areas, higher rice prices are linked to lower child dependency and better sanitation.

*Why? Here’s what might be happening:*

Rising prices might reflect a broader economic shift — like inflation, wage growth, or improved infrastructure — which benefits some urban families.

Urban households often have better access to education and healthcare, so as living costs rise, they might choose to have fewer children to maintain a stable life.

Government and NGO programs targeting urban slums may also improve sanitation faster when prices are rising, as poverty becomes more visible.

- High rice prices can hurt poor urban families, but overall, they may signal economic changes that lead to smaller, more resilient households.


# Tracking Sanitation Improvements Over Time: Rajshahi’s Toilet Access

While earlier visualizations used toilet access as a snapshot proxy for poverty, it’s equally important to look at how this indicator has evolved over time. The bar chart below shows the percentage of households **without access to toilets** from 1991 to 2011 in both rural and urban areas of Rajshahi Division.

This trend is crucial because it reflects not just economic conditions, but also investments in **infrastructure, public health, and basic dignity**. Improvements in sanitation often signal broader social progress — and help explain the shifts we’ve seen in child dependency and family composition.

```{r fig.align='center', echo=FALSE, out.width='75%'}
knitr::include_graphics("~/Desktop/ECNS_560_REDO/Plots/poverty_proxy_area_type_rajshahi.png")
```
*Interpretation:*

Between 1991 and 2011, access to sanitation improved significantly in Rajshahi — in both rural and urban areas:

- In **1991**, 40% of rural households and 38% of urban households lacked toilet access — a near parity in deprivation.
- By **2011**, those numbers dropped to **12.2%** for rural and **9.5%** for urban areas, marking remarkable progress.

This steady decline mirrors the broader narrative of the project: even as rice prices fluctuated and poverty persisted in certain pockets, **sanitation infrastructure steadily improved** — suggesting a national or regional shift in public investment or behavior change.

Urban areas consistently had slightly better access, but the **gap between rural and urban sanitation has narrowed over time**, which is a hopeful sign for equity in infrastructure development.

These improvements likely contributed to the overall decline in child dependency as well — with better hygiene, health outcomes improve, and households may feel more secure and empowered to make different family planning decisions.
